...
define config.name = _("Brief vom Himmel")
...
define gui.about = _p("""感谢曾为我作出指导的各位。（特别是那些能白嫖的网站）

场景：
    {a=https://min-chi.material.jp/}みんちりえ{/a}

立绘：
    {a=https://www.dlsite.com/home/circle/profile/=/maker_id/RG29527.html}
    糖度70%{/a}\n
    {a=https://www.dlsite.com/home/circle/profile/=/maker_id/RG01014340.html}           ましろんショップ{/a}
...
define build.name = "BriefvomHimmel"
...
# define config.main_menu_music = menu_musics(5)
...
define config.save_directory = "BriefvomHimmel-1715498159"
